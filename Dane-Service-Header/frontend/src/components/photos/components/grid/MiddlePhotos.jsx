...
const MiddlePhotos = (props) => (
    <React.Fragment>
        <ContainerTop className={'photo-container'} onClick={() => props.handleClick(props.photo1.id)}>
            <MiddleImg src={props.photo1.link} alt={'house'} />
        </ContainerTop>
        <ContainerBottom className={'photo-container'} onClick={() => props.handleClick(props.photo2.id)}>
