...
app.get('/5ca84c8b46006370e2258ab10bde88a2.svg', (_req, res) => {
    res.sendFile(path.join(__dirname, 'dist', '5ca84c8b46006370e2258ab10bde88a2.svg'));
});

app.get('/8ac961c2913677bea803b50ac04c2f21.svg', (_req, res) => {
    res.sendFile(path.join(__dirname, 'dist', '8ac961c2913677bea803b50ac04c2f21.svg'));
});

app.get('/ccbcb172e382c7f580cbf5b8c6c09a35.svg', (_req, res) => {
    res.sendFile(path.join(__dirname, 'dist', 'ccbcb172e382c7f580cbf5b8c6c09a35.svg'));
});
